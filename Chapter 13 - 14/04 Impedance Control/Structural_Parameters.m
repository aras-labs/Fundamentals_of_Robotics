...
SP.pert = 0.8;              % SP.pert * parameter perterbation
...
%
SP.tau_limit=[100; 100; 10];    % Torque limits
...
SP.Kd=1e2*diag([1 2 0.2]); % The proportional Impedance gain 
SP.Cd=5e2*diag([1 2 0.2]); % The  derivative controller gain 
SP.Md=1e0*diag([1 0.1 0.01]); % The desired Mass Matrix
