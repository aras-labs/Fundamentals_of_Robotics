...
S3=SR(0,1,0,d2,0,0,0,d3);
S4=SR(0,1,0,d2,0,0,theta4,0);
S5=SR(0,0,1,d2,0,0,theta5,0);
S6=SR(0,1,0,d2,0,0,theta6,0);
...
%
U0=[1;0;0];V0=[0;0;-1];W0=[0;1;0];P0=[d2;0;0];Ze=[0,0,0];
S0=[U0,V0,W0,P0;Ze,1];
%
...
%% Verification
%
%   Note that the initial position in the DH and Screw representation are
%   different. In DH method the robot arm shall be in vertical position to
%   remain in initial state. However, in the above screw method the arm is
%   considered in horizontal posion at initial state. 
%
%   This cause the two derivation result into two different solutions
%   To remedy this consider the notation given in Paul's book (page 56)
